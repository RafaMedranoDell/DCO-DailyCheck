...
CHANGELOG = [
    ...
    ("1.13.0", "ESX",   "New ESX standalone module to monitor ESXi hosts without vCenter (SOAP/pyVmomi)"),
    ...
    ("1.16.3", "PPCR",    "Added storage alerts to System & Storage Alerts table in DC report"),
]
